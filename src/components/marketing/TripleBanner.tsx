...
export default function TripleBanner() {
  return (
    <div className="triple-banner flex flex-col md:flex-row font-serif h-full w-full">
      {/* 1. SECCIÓN MUJER */}
      <section className="triple-banner__section triple-banner__section--women bg-triple-women relative flex-1 group overflow-hidden bg-cover bg-top bg-no-repeat flex flex-col justify-center items-center text-center p-10 transition-all duration-500 hover:flex-[1.3] cursor-pointer h-full">
        {/* Overlay */}
      ...
      {/* 2. SECCIÓN HOMBRE */}
      <section className="triple-banner__section triple-banner__section--men bg-triple-men relative flex-1 group overflow-hidden bg-cover bg-center bg-no-repeat flex flex-col justify-center items-center text-center p-10 transition-all duration-500 hover:flex-[1.5] cursor-pointer h-full">
      ...
      {/* 3. SECCIÓN NIÑA */}
      <section className="triple-banner__section triple-banner__section--junior bg-triple-junior relative flex-1 group overflow-hidden bg-cover bg-center bg-no-repeat flex flex-col justify-center items-center text-center p-8 transition-all duration-500 hover:flex-[1.5] cursor-pointer h-full pb-16">
