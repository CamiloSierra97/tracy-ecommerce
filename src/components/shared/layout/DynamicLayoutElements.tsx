...
const CookieBanner = dynamic(() => import("@/components/shared/layout/CookieBanner"), {
  ssr: false,
});

const FloatingButtons = dynamic(
  () => import("@/components/shared/layout/FloatingButtons")
);

const Toast = dynamic(() => import("@/components/shared/ui/Toast"), { ssr: false });
