...
/* Contenido interno de la tarjeta, extraído para reutilizar
   entre el wrapper con/sin animación */
  ...
  return (
    <>
      ...
      <div className="product-card__image-container relative aspect-3/4 overflow-hidden rounded-3xl shadow-sm transition-all duration-500 ease-out lg:group-hover:shadow-premium lg:group-hover:border-gold border border-transparent lg:group-hover:scale-[1.02] transform">
        ...
        >
          <span className="product-card__btn-text w-2/3 text-black/80 font-medium py-2 px-3 md:py-3 md:px-4 rounded-md shadow-lg text-center text-sm transform active:scale-95 lg:hover:scale-105 lg:hover:text-[rgba(0,0,0,1)] lg:hover:border lg:hover:border-[rgba(0,0,0,1)] lg:hover:backdrop-blur-md transition-all">
            Ver Detalles
          </span>
        </Link>
      </div>
...
export default function ProductCard({
  ...
  return (
    <li className="product-card group relative">
      {/* Sin animación para LCP cards (priority), con fade-in para el resto */}
      {priority ? (
        <div className="product-card__content h-full flex flex-col relative">
