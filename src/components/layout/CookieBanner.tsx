      ...
      <div className="cookie-banner__container container mx-auto max-w-6xl flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="cookie-banner__content flex-1 text-sm leading-relaxed">
          <p className="cookie-banner__text text-black">
            ...
            <Link
              href="/cookies"
              className="cookie-banner__link text-burgundy font-medium underline decoration-burgundy/50 underline-offset-4 hover:text-gold hover:decoration-gold transition-all hover:cursor-pointer"
            >
              Política de Cookies
            </Link>{" "}
            y{" "}
        ...
        <div className="cookie-banner__actions flex items-center gap-3">
          <button
            ...
            className="cookie-banner__btn cookie-banner__btn--accept bg-burgundy text-ivory px-6 py-2 rounded-full font-medium text-sm hover:bg-burgundy-light hover:text-black transition-colors whitespace-nowrap cursor-pointer focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gold"
          >
            Aceptar todo
          </button>
          <button
