...
export default function TripleBanner() {
  return (
    <div className="triple-banner flex flex-col md:flex-row font-serif h-full w-full">
      {/* 1. SECCIÓN MUJER */}
      <section className="triple-banner__section triple-banner__section--women bg-triple-women relative flex-1 group overflow-hidden bg-cover bg-center bg-no-repeat flex flex-col justify-center items-center text-center p-8 transition-all duration-500 hover:flex-[1.3] cursor-pointer h-full">
        {/* Overlay */}
        ...
        <div className="triple-banner__content relative z-10 flex flex-col items-center">
          ...
          <Link
            href="/mujer"
            className="triple-banner__link inline-flex items-center gap-2 text-gold border-b border-golden pb-1 hover:text-white hover:border-white transition-all uppercase text-sm tracking-widest"
          >
