...
const HeroSection: React.FC = () => {
  return (
    <section className="hero size-full flex flex-col md:flex-row justify-center">
      {/* <aside> para contenido tangencial: la imagen de fondo */}
      <figure className="hero__image-container hidden md:block w-full h-screen md:w-1/2 md:h-screen lg:w-1/3 lg:h-[90vh] relative bg-burgundy">
        <Image
          src="/Background1.svg"
