          ...
          <article className="bg-white p-8 rounded-2xl shadow-sm border border-gold/10">
            ...
            <div className="prose prose-stone max-w-none">
              ...
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li>
                  <strong>Costo:</strong> Envío gratis por compras superiores a
                  $200.000 COP.
                </li>
                <li>
                  <strong>Seguimiento:</strong> Recibirás un número de guía para
                  rastrear tu paquete tan pronto sea despachado.
                </li>
              </ul>
            </div>
          </article>
          ...
          <article className="bg-white p-8 rounded-2xl shadow-sm border border-gold/10">
            ...
            <div className="prose prose-stone max-w-none">
              <p className="mb-4">
                ...
                <strong>
                  la ropa interior (panties, bodies, lencería inferior) no tiene
                  cambio
                </strong>
              ...
              <p className="mb-4">
                ...
                <strong>5 días hábiles</strong> después de recibido el producto,
                siempre y cuando:
              </p>
              <ul className="list-disc pl-5 space-y-2">
                <li>
              ...
              <p className="mt-4 text-sm text-gray-500 italic">
                Nota: Los costos de envío por cambios de talla corren por cuenta
                del cliente.
              </p>
            </div>
          </article>
